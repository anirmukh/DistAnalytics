...
header('Location: ../Pos/pos_distributer.php?idno='.$region."&idno1=".$item);
}
?>
    <meta charset="utf-8">
                ...
                <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        if($_SESSION['arr96'])
                        {
                            ...
                            {
                                $arr96[$iiii]["DISTRIBUTOR_NAME"]=$value["DIST_NAME"].", Count= ".$value['count'];
                                $arr96[$iiii++]["COUNT"]=$value['count'];
                                $arr1[$v]["DISTRIBUTOR_NAME"]=$value["DIST_NAME"];
                            ...
                            include("../Pos/high_pos_distributer.php");
                            //including the angularjs file to display the table
                            include('../Pos/angular_pos_distributer.php');
