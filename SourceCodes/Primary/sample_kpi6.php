...
if(!isset($_SESSION['primary']))
{
    ...
    header('Location: ../Primary/primary_secondary.php');
}
?>
    <meta charset="utf-8">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Primary/Secondary Recharges</h1>
                         <div class="col-lg-20">
                    <div class="panel panel-primary">
                        <div class="panel-body">
                        <?php
                                //retrieval of session variables
                                $arr1=$_SESSION['primary'];
                                $arr2=$_SESSION['secondary'];
                                $date1=$_SESSION['date1'];
                                $date2=$_SESSION['date2'];
                                $date3=$_SESSION['date3'];
                                //variables are echoed as JS variables to be used in AngularJS
                                ...
                                echo '</script>';
                                //including the angular JS files for both primary and secondary recharge
                                include('../Primary/angular_primary.php');
                                include('../Primary/angular_secondary.php');   
                                session_destroy();
                        ?>
                </div>
                    <!-- /.col-lg-12 -->
