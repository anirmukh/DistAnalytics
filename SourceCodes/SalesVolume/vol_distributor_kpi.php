...
if(isset($_GET['idno']))
{
    $region=$_GET['idno'];
    $item=$_GET['idno1'];
    header('Location: ../SalesVolume/vol_distributor.php?idno='.$region."&idno1=".$item);
}
?>
   <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php
                            ...
                            if($_SESSION['arr96'])
                            {
                                include("../SalesVolume/high_vol_distributor.php");
                                ...
                                echo '</script>';
                                include('../SalesVolume/angular_vol_distributor.php');
                                @ session_destroy();     
                            }
                        ?>
                </div>
