            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <?php
                        @ session_start();
                         //to check the equality of two strings
                        function check($a,$b)
                        {
                            if(strcmp($a,$b)==0)
                                return "selected";
                        ...
                        {
                            echo "<form action='../SalesVolume/sample.php?id=1'>";
                            ...
                            echo "</select><br><br>";
                            echo "
                                <input class='form-control' type='submit' name='sbt' value='SUBMIT'>
                                </input>";
                        ...
                        if(isset($_SESSION['year']))
                        {
                            ...
                            //associative array to derive the month name based on month number
                             ...
                             echo "<form action='sample.php?id=1'>";
                             echo " <div class='form-group'>";
                             echo "<label>Year:</label> ";
                             echo "<p><select name='sel_year' class='form-control'></p>";
                        ...
                        $month1=array("JANUARY","FEBRUARY","MARCH","APRIL","MAY","JUNE","JULY","AUGUST","SEPTEMBER","OCTOBER","NOVEMBER","DECEMBER");
                             ...
                             echo "</select><br><br>";
                             echo "<input type='submit' name='sbt' value='SUBMIT' class='form-control'>
                                   </input>";
                             echo "</div></form></div></div>";
                            include('../SalesVolume/high_sample_volume.php');
                            echo '<script>';
                            echo 'var name= ' . json_encode($_SESSION['items']) . ';';
                            echo 'var name2 = ' . json_encode($_SESSION['vol']) . ';';
