...
<?php
@ session_start();
if(!isset($_SESSION['saf']))
{
    header('Location: ../SAF/sample_saf.php');//Going to the service page
}
?>
    <meta charset="utf-8">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">SAF Collected</h1>
                         <div class="col-lg-20">
                    <div class="panel panel-primary">
                        ...
                        <?php
                             if(isset($_SESSION['saf']))
                             {
                                ...
                                echo '</script>';
                                //including the angularjs file of the SAF
                                include('../SAF/angular_saf.php');
                                session_destroy();
                            }
