...
if(isset($_GET['idno']))
{
    ...
    header('Location: ../SalesCount/item_district.php?idno='.$region."&idno1=".$item);
}
?>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <?php
                            ...
                            if(isset($_SESSION['arr96']))
                            {
                                ...
                                include("../SalesCount/high_item_district.php");
                                //including the angularjs file to display the table 
                                include('../SalesCount/angular_item_district.php');
