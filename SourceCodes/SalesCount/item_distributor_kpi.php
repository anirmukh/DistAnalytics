...
header('Location: ../SalesCount/item_distributor.php?idno='.$region."&idno1=".$item);
}
?>
   <meta charset="utf-8">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Sales Count</h1>
                         <div class="col-lg-20">
                    <div class="panel panel-primary">
                        ...
                        <?php
                            ...
                            if($_SESSION['arr96'])
                            {
                                ...
                                {
                                    $arr96[$iiii]["DISTRIBUTOR_NAME"]=$value["DISTRIBUTOR_NAME"].", Count= ".$value['count'];
                                    $arr96[$iiii++]["COUNT"]=$value['count'];
                                    $arr1[$v]["DISTRIBUTOR_NAME"]=$value["DISTRIBUTOR_NAME"];
