...
if(isset($_GET['idno']))
{
    ...
    header('Location: ../SalesCount/region_count.php?idno='.$year."&idno1=".$mnt);
}
?>
  <meta charset="utf-8">
                        ...
                        <div class="panel-body">
                            <?php
                                ...
                                if(isset($_SESSION['items']))
                                {
                                    ...
                                    $count=sizeof($arr);//Finding the size of associative array
                                    $keys= array_keys($arr);//Finding out the keys in the associative array
                                    $v=0;
                                    $flag=0;
                                    $i=0;
                                    $j=0;
                                    ...
                                    include("../SalesCount/angular_region_count.php");
