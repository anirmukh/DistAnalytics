...
<?php
    ...
    {
        //passing control to the service page
        header('Location: ../Activation/unit_recharging.php');
    }
?>
    <meta charset="utf-8">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Unit Activation/Recharging Outlets</h1>
                         <div class="col-lg-20">
                    <div class="panel panel-primary">
                       ...
                       <?php
                            if(isset($_SESSION['activation']))
                            {
                                //coming back from the service page
                                $arr1=$_SESSION['activation'];
                                $arr2=$_SESSION['recharging'];
                                $date1=$_SESSION['date1'];
                                $date2=$_SESSION['date2'];
                                $date3=$_SESSION['date3'];
                                //echoing session variable as JS variables so as to use them in angular JS files
                                echo '<script>var dis1='.json_encode($arr1).';';
                                echo 'var dis2= ' . json_encode($arr2) . ';';
                                echo 'var d2='.json_encode($date3).';';
                                echo 'var d1='.json_encode($date2).';';
                                echo 'var d='.json_encode($date1).';';
                                echo '</script>';
                                //including the angular JS files for both activation and recharging
                                include('../Activation/angular_activation.php');
                                include('../Activation/angular_recharging.php');   
                                session_destroy();
                             }
                        ?>
                </div>
