...
if(isset($_GET['idno']))
{
    ...
    header("Location: ../SIM/sms_distributor.php?idno=".$reg);
}
?>
   <meta charset="utf-8">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">SIM Activation</h1>
                         <div class="col-lg-20">
                    <div class="panel panel-primary">
                        ...
                        {
                            //Storing the session variables in local variables to use it in highcharts and angularjs file
                            $i=$_SESSION['i'];
                            $regions=$_SESSION['regions'];
                            $arr=$_SESSION['arr6'];
                            //declaring the script variables to be used in the highcharts and angularjs file for displaying
                            echo '<script>';
                            echo 'var d= ' . json_encode($regions) . ';';
                            echo 'var ss3 = ' . json_encode($i) . ';';
                            echo 'var disp= '.json_encode($arr).';';
                            echo '</script>';
                            //including the highcharts file to display the graph
                            include("../SIM/high_sms_distributor.php");
                            //including the angularjs file to display the table
                            include("../SIM/angular_sms_distributor.php");
